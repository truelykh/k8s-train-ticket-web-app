...
public class OrderOtherServiceImplTest {
    ...
    public void testGetSoldTickets1() {
        ...
        list.add(new Order());
        Mockito.when(orderOtherRepository.findByTravelDateAndTrainNumber(Mockito.any(), Mockito.anyString())).thenReturn(list);
    ...
    public void testGetSoldTickets2() {
        Seat seatRequest = new Seat();
        Mockito.when(orderOtherRepository.findByTravelDateAndTrainNumber(Mockito.any(), Mockito.anyString())).thenReturn(null);
        Response result = orderOtherServiceImpl.getSoldTickets(seatRequest, headers);
    ...
    public void testFindOrderById1() {
        ...
        Mockito.when(orderOtherRepository.findById(Mockito.any())).thenReturn(java.util.Optional.empty());
    ...
    public void testFindOrderById2() {
        ...
        Mockito.when(orderOtherRepository.findById(Mockito.any())).thenReturn(java.util.Optional.of(order));
        Response result = orderOtherServiceImpl.findOrderById(id, headers);
    ...
    public void testCreate1() {
        ...
        Mockito.when(orderOtherRepository.findByAccountId(Mockito.any())).thenReturn(accountOrders);
    ...
    public void testQueryOrders() {
        ...
        order.setStatus(1);
        list.add(order);
        Mockito.when(orderOtherRepository.findByAccountId(Mockito.any())).thenReturn(list);
    ...
    public void testCancelOrder2() {
        ...
        Mockito.when(orderOtherRepository.findById(Mockito.any())).thenReturn(java.util.Optional.of(oldOrder));
        Mockito.when(orderOtherRepository.save(Mockito.any(Order.class))).thenAnswer(i -> i.getArguments()[0]);
        Response result = orderOtherServiceImpl.cancelOrder(UUID.randomUUID().toString(), UUID.randomUUID().toString(), headers);
        Assert.assertEquals("Success", result.getMsg());
    }
    ...
    public void testQueryAlreadySoldOrders() {
        ...
        Mockito.when(orderOtherRepository.findByTravelDateAndTrainNumber(Mockito.any(), Mockito.anyString())).thenReturn(orders);
    ...
    public void testCheckSecurityAboutOrder() {
        ArrayList<Order> orders = new ArrayList<>();
        Mockito.when(orderOtherRepository.findByAccountId(Mockito.any())).thenReturn(orders);
    ...
    public void testDeleteOrder2() {
        ...
        Mockito.when(orderOtherRepository.findById(Mockito.any())).thenReturn(java.util.Optional.of(order));
        Mockito.doNothing().doThrow(new RuntimeException()).when(orderOtherRepository).deleteById(Mockito.any());
