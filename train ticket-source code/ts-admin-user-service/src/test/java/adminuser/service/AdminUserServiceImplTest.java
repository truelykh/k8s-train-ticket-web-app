...
public class AdminUserServiceImplTest {
    ...
    private HttpHeaders newHeadersWithToken() {
    ...
    public void testGetAllUsers() {
        ...
        Mockito.when(restTemplate.exchange(
                "http://ts-user-service/api/v1/userservice/users",
                HttpMethod.GET,
                requestEntity,
    ...
    public void testDeleteUser() {
        ...
        Mockito.when(restTemplate.exchange(
                "http://ts-user-service/api/v1/userservice/users" + "/" + "userId",
                HttpMethod.DELETE,
                new HttpEntity<Response>(newHeadersWithToken()),
    ...
    public void testUpdateUser() {
        ...
        HttpEntity requestEntity2 = new HttpEntity(userDto, newHeadersWithToken());
        Response response = new Response<>(1, null, null);
        ResponseEntity<Response> re = new ResponseEntity<>(response, HttpStatus.OK);
        Mockito.when(restTemplate.exchange(
                "http://ts-user-service/api/v1/userservice/users",
    ...
    public void testAddUser() {
        ...
        Mockito.when(restTemplate.exchange(
                "http://ts-user-service/api/v1/userservice/users" + "/register",
                HttpMethod.POST,
                requestEntity2,
