...
public class AdminBasicInfoServiceImplTest {
    ...
    public void testDeleteStation() {
        Mockito.when(restTemplate.exchange(
                "http://ts-station-service/api/v1/stationservice/stations/" + "id",
                HttpMethod.DELETE,
                requestEntity,
                Response.class)).thenReturn(re);
        response = adminBasicInfoService.deleteStation("id", headers);
        Assert.assertEquals(new Response<>(null, null, null), response);
    }
    ...
    public void testDeletePrice() {
        Mockito.when(restTemplate.exchange(
                "http://ts-price-service/api/v1/priceservice/prices/" + "id",
                HttpMethod.DELETE,
                requestEntity,
                Response.class)).thenReturn(re);
        response = adminBasicInfoService.deletePrice("id", headers);
        Assert.assertEquals(new Response<>(null, null, null), response);
    }
