...
public class TravelPlanServiceImplTest {
    ...
    public void testGetCheapest() {
        ...
        //response for queryTrainTypeByName() - uses Response.class, not ParameterizedTypeReference
        TrainType trainType = new TrainType();
        trainType.setConfortClass(100);
        trainType.setEconomyClass(100);
        Response responseTrainType = new Response(null, null, trainType);
        ResponseEntity<Response> reTrainType = new ResponseEntity<>(responseTrainType, HttpStatus.OK);
        Mockito.when(restTemplate.exchange(
                Mockito.anyString(),
                Mockito.any(HttpMethod.class),
                Mockito.any(HttpEntity.class),
