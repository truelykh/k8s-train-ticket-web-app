...
public class StationFoodControllerTest {
    ...
    public void testHome() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/stationfoodservice/stationfoodstores/welcome"))
    ...
    public void testGetAllFoodStores() throws Exception {
        ...
        String result = mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/stationfoodservice/stationfoodstores"))
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    public void testGetFoodStoresOfStation() throws Exception {
        ...
        String result = mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/stationfoodservice/stationfoodstores/station_id"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andReturn().getResponse().getContentAsString();
        Assert.assertEquals(response, JSONObject.parseObject(result, Response.class));
    }
    ...
    public void testGetFoodStoresByStationNames() throws Exception {
        ...
        String result = mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/stationfoodservice/stationfoodstores").contentType(MediaType.APPLICATION_JSON).content(requestJson))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andReturn().getResponse().getContentAsString();
        Assert.assertEquals(response, JSONObject.parseObject(result, Response.class));
    }
